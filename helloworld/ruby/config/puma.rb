...
if RAILS_ENV != 'development' || ENV['PUMA_OUTPUT_LOGFILE'] == 'true'
  stdout_redirect File.join(RAILS_ROOT, 'log', CONFIG['log']['stdout']), File.join(RAILS_ROOT, 'log', CONFIG['log']['stderr']), CONFIG['log']['append']
end
